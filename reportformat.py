...
from PyQt5.QtWidgets import QDialog, QSpinBox, QLabel, QDialogButtonBox
...
class MainWindow(QMainWindow):
    ...
    def add_table(self):
       rows, columns, ok = TableDialog.get_table_dimensions(self)
       if ok:
        self.editor.insert_table(rows, columns)
...
class TableDialog(QDialog):
    ...
    def get_table_dimensions(parent=None):
        ...
        columns = dialog.columns_spinbox.value()
        return rows, columns, result == QDialog.Accepted
